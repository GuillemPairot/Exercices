...
namespace PeopleViewer
{
    public partial class App : Application
    {
        ...
        private void ComposeObject()
        {
            ...
            //IRepository repository = new ServiceReader();
            //// TODO 3-2 : Créer le view model (PeopleViewModel)
            //PeopleViewModel peopleViewModel = new PeopleViewModel(repository);
            ...
            //IRepository cashingreader = new CachingReader(repository);
